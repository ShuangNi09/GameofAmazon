...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->autoBlack", this::autoBlack);
        addMenuButton("Settings->autoWhite", this::autoWhite);
        addMenuButton("Settings->manualBlack", this::manualBlack);
        addMenuButton("Settings->manualWhite", this::manualWhite);
